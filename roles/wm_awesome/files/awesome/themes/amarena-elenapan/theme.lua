...
theme.wibar_fg = xrdb.background
theme.wibar_bg = xrdb.foreground
...
-- Dashboard
theme.dashboard_bg = xrdb.color0.."CC"
theme.dashboard_fg = xrdb.color7
...
theme.taglist_text_color_empty  = { xrdb.background.."22", xrdb.background.."22", xrdb.background.."22", xrdb.background.."22", xrdb.background.."22", xrdb.background.."22", xrdb.background.."22", xrdb.background.."22", xrdb.background.."22", xrdb.background.."22" }
-- theme.taglist_text_color_occupied  = { xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0" }
-- theme.taglist_text_color_focused  = { xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0", xrdb.foreground.."F0" }
-- theme.taglist_text_color_urgent  = { xrdb.foreground, xrdb.foreground, xrdb.foreground, xrdb.foreground, xrdb.foreground, xrdb.foreground, xrdb.foreground, xrdb.foreground, xrdb.foreground, xrdb.foreground }

theme.taglist_text_color_occupied  = { xrdb.color1.."99", xrdb.color2.."99", xrdb.color3.."99", xrdb.color4.."99", xrdb.color5.."99", xrdb.color6.."99", xrdb.color1.."99", xrdb.color2.."99", xrdb.color3.."99", xrdb.color4.."99" }
theme.taglist_text_color_focused  = { xrdb.color9, xrdb.color10, xrdb.color11, xrdb.color12, xrdb.color13, xrdb.color14, xrdb.color9, xrdb.color10, xrdb.color11, xrdb.color12 }
theme.taglist_text_color_urgent   = { xrdb.background, xrdb.background, xrdb.background, xrdb.background, xrdb.background, xrdb.background, xrdb.background, xrdb.background, xrdb.background, xrdb.background }
-- theme.taglist_text_color_urgent   = { xrdb.color9, xrdb.color10, xrdb.color11, xrdb.color12, xrdb.color13, xrdb.color14, xrdb.color9, xrdb.color10, xrdb.color11, xrdb.color12 }
...
theme.taglist_fg_focus = xrdb.color12
theme.taglist_bg_occupied = xrdb.background
theme.taglist_fg_occupied = xrdb.color8
theme.taglist_bg_empty = xrdb.background
theme.taglist_fg_empty = xrdb.background
theme.taglist_bg_urgent = xrdb.background
theme.taglist_fg_urgent = xrdb.color3
...
-- theme.desktop_mode_color_tile = xrdb.color3
-- theme.desktop_mode_color_max = xrdb.color1
...
theme.minimal_tasklist_visible_clients_color = xrdb.color4
theme.minimal_tasklist_visible_clients_text = ""
theme.minimal_tasklist_hidden_clients_color = xrdb.color7
theme.minimal_tasklist_hidden_clients_text = ""

-- Mpd song
theme.mpd_song_title_color = xrdb.color7
theme.mpd_song_artist_color = xrdb.color7
theme.mpd_song_paused_color = xrdb.color8

-- Volume bar
theme.volume_bar_active_color = xrdb.color5
theme.volume_bar_active_background_color = xrdb.color0
theme.volume_bar_muted_color = xrdb.color8
theme.volume_bar_muted_background_color = xrdb.color0

-- Temperature bar
theme.temperature_bar_active_color = xrdb.color1
theme.temperature_bar_background_color = xrdb.color0

-- Battery bar
theme.battery_bar_active_color = xrdb.color6
theme.battery_bar_background_color = xrdb.color0

-- CPU bar
theme.cpu_bar_active_color = xrdb.color2
theme.cpu_bar_background_color = xrdb.color0

-- RAM bar
theme.ram_bar_active_color = xrdb.color4
theme.ram_bar_background_color = xrdb.color0

-- Brightness bar
theme.brightness_bar_active_color = xrdb.color3
theme.brightness_bar_background_color = xrdb.color0
